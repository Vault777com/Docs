    ...
    nav: [
      ...
      { text: 'Quick Start', link: '/General/quickstart.md' },
      {
        ...
        items: [
          ...
          { text: 'Platform Economics', link: '/General/economics.md' },
          { text: 'Tokenomics', link: '/General/tokenomics.md' }
        ]
      },
      {
        text: '🚧 Game Dev Docs 🚧',
        items: [
          { text: 'Terms Of Service', link: '/Developer/tos.md' },
          { text: 'Quick Start', link: '/Developer/quickstart.md' },
          { text: 'Web Game Creator', link: '/Developer/webgamecreator.md' },
          { text: 'Design Games', link: '/Developer/gamedesign.md' },
          { text: 'Mobile Guideline', link: '/Developer/mobileguideline.md' },
          { text: 'Slots Example', link: '/Developer/slotsexample.md' }
        ]
      }
    ],
